    ...
    def extraermenu(self,tipo):
        try:
            if tipo == "admin":
                ...
                if tipo == "usuario":
                    usermenu = {"Home":"/home","Agendar una cita":"/citas/agregar", "Historiales":"/historial","Atencion":"/atencion","Agregar receta":"/recetas/agregar","Agendar una atencion":"/atencion/agregar","Mascotas":"/mascotas"}
                else:
                    if tipo == "cliente":
                        usermenu = {"Home":"/home","Agendar una cita":"/citas/agregar", "Historiales":"/historial","Mascotas":"/mascotas"}
            return usermenu
        except Exception as ex:
            raise Exception(ex)
